...
object RRBVector {
    ...
    def empty[A]: RRBVector[A] = EMPTY_VECTOR

    private[rrbvector] final val emptyTransientBlock = new Array[AnyRef](2)
}

final class RRBVector[+A] private[rrbvector](override private[rrbvector] val endIndex: Int) extends Traversable[A] with TraversableLike[A, RRBVector[A]] with Iterable[A] with IterableLike[A, RRBVector[A]] with RRBVectorPointer[A@uncheckedVariance] with Serializable {
  self =>
...
class RRBVectorIterator[+A](startIndex: Int, override private[rrbvector] val endIndex: Int) extends Iterator[A] with RRBVectorPointer[A@uncheckedVariance] {
    ...
    private[rrbvector] final def initIteratorFrom[B >: A](that: RRBVectorPointer[B]): Unit = {
...
class RRBVectorReverseIterator[+A](startIndex: Int, final override private[rrbvector] val endIndex: Int) extends Iterator[A] with RRBVectorPointer[A@uncheckedVariance] {
...
private[rrbvector] trait RRBVectorPointer[A] {
    private[rrbvector] final var display0: Array[AnyRef] = _
    ...
    private[rrbvector] final def initWithFocusFrom[U](that: RRBVectorPointer[U]): Unit = {
        initFocus(that.focus, that.focusStart, that.focusEnd, that.focusDepth, that.focusRelax)
        initFrom(that)
    }

    private[rrbvector] final def initFocus[U](focus: Int, focusStart: Int, focusEnd: Int, focusDepth: Int, focusRelax: Int): Unit = {
        this.focus = focus
    ...
    private[rrbvector] final def initFromDisplays[U](display0: Array[AnyRef]): Unit = {
        this.depth = 1
        this.display0 = display0
    }

    private[rrbvector] final def initFromDisplays[U](display0: Array[AnyRef], display1: Array[AnyRef]): Unit = {
        this.depth = 2
        this.display0 = display0
        this.display1 = display1
    }

    private[rrbvector] final def initFromDisplays[U](display0: Array[AnyRef], display1: Array[AnyRef], display2: Array[AnyRef]): Unit = {
        this.depth = 3
        this.display0 = display0
        this.display1 = display1
    ...
    private[rrbvector] final def initFromDisplays[U](display0: Array[AnyRef], display1: Array[AnyRef], display2: Array[AnyRef], display3: Array[AnyRef]): Unit = {
        this.depth = 4
        this.display0 = display0
        this.display1 = display1
        this.display2 = display2
    ...
    private[rrbvector] final def initFromDisplays[U](display0: Array[AnyRef], display1: Array[AnyRef], display2: Array[AnyRef], display3: Array[AnyRef], display4: Array[AnyRef]): Unit = {
        this.depth = 5
        this.display0 = display0
        this.display1 = display1
        this.display2 = display2
    ...
    private[rrbvector] final def initFromDisplays[U](display0: Array[AnyRef], display1: Array[AnyRef], display2: Array[AnyRef], display3: Array[AnyRef], display4: Array[AnyRef], display5: Array[AnyRef]): Unit = {
        this.depth = 6
        this.display0 = display0
        this.display1 = display1
    ...
    private[rrbvector] final def initFrom[U](that: RRBVectorPointer[U]): Unit = {
        if (RRBVector.compileAssertions) {
            assert(that != null)
        }
        depth = that.depth
    ...
    private[rrbvector] final def initSingleton[B >: A](elem: B): Unit = {
        initFocus(0, 0, 1, 1, 0)
    ...
    private[rrbvector] final def makeTransientSizes(oldSizes: Array[Int], transientBranchIndex: Int): Array[Int] = {
...
trait TraversableLike[ +T, +Repr] {
  ...
  def mapTo[ U, To](f: T => U)(b: Builder[U, To]): To = {
    foreach(t => b += f(t))
    b.finalise
  }

  def map[U, That](f: T => U)(implicit cbf: CanBuildFrom[Repr, U, That]): That = mapTo[U, That](f)(cbf())
